  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        premium: "bg-primary text-primary-foreground hover:bg-foreground/80 tracking-luxury uppercase text-xs font-body font-semibold rounded-none border border-primary hover:border-foreground/80",
        "premium-outline": "border border-primary text-primary hover:bg-primary hover:text-primary-foreground tracking-luxury uppercase text-xs font-body font-semibold rounded-none",
        gold: "bg-gold text-white hover:bg-gold/90 tracking-luxury uppercase text-xs font-body font-semibold rounded-none",
      },
      size: {
